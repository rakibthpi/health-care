...
!(function (t, e) {
  ...
  function g(t, e, n) {
    ...
    return (
      void 0 === n
        ? e && Object.getPrototypeOf(e) === Object.prototype && (a[s] = { ...i, ...e })
        : void 0 !== e && (i[e] = n),
      n
    );
  }
        ...
        return (
          ...
          s.words || s.lines
            ? ((c = P(o, {
                ...
                style:
                  'display: inline-block; ' + (s.words && n.absolute ? 'position: relative;' : ''),
    ...
    return (
      ...
      l(r).forEach((i) => {
        ...
        /^br$/i.test(i.nodeName) ||
          (s.lines && o && ((null === a || d - a >= S) && ((a = d), c.push((u = []))), u.push(i)),
          e.absolute &&
            g(i, {
              top: d,
              left: p,
