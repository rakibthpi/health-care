    ...
    var S = (function () {
        ...
        return (
          ...
          (e.prototype._initPanel = function (e) {
            ...
            if (
              (i ? a && a.classList.add('mm-listitem_vertical') : this.node.pnls.append(e),
              a &&
                ((a.mmChild = e),
                (e.mmParent = a),
                  ...
                  if (n) {
                    for (
                      var i = {
                          ...
                          toExternal:
                            n.matches('[rel="external"]') || n.matches('[target="_blank"]'),
                        },
                        s = {
                          close: null,
                          setSelected: null,
              ...
              if (n.matches('.mm-tabend')) {
                ...
                (n.parentElement.matches('.mm-menu') && S.node.blck && (i = S.node.blck),
                  n.parentElement.matches('.mm-wrapper__blocker') &&
                    (i = g(document.body, '.mm-menu_offcanvas.mm-menu_opened')[0]),
                  i || (i = n.parentElement),
      ...
      (_e.navbarContents = {
            ...
            this.bind('initNavbar:after', function (e) {
              if (!e.querySelector('.mm-navbar__breadcrumbs')) {
                ...
                for (var n = [], i = b('span.mm-navbar__breadcrumbs'), s = e, a = !0; s; ) {
                  if (
                    !(s = s.closest('.mm-panel')).parentElement.matches('.mm-listitem_vertical')
                  ) {
        ...
        title: function (e) {
          ...
          (o.append(r),
            ...
            this.bind('openPanel:start', function (e) {
              e.parentElement.matches('.mm-listitem_vertical') ||
                ((i = e.querySelector('.' + a.conf.classNames.navbars.panelTitle)) ||
          ...
          (s.showSubPanels &&
              ...
              .forEach(function (t, n) {
                ...
                s &&
                  (w(g(t, '.mm-listitem')).length
                    ? (s.matches('.mm-hidden') && s.classList.remove('mm-hidden'),
            ...
            c.forEach(function (e) {
              w(g(e, '.mm-listitem')).forEach(function (e) {
                y(e, '.mm-listitem_vertical').forEach(function (e) {
                  e.matches('.mm-hidden') &&
                    (e.classList.remove('mm-hidden'), e.classList.add('mm-listitem_onlysubitems'));
                });
              });
            }),
            c.forEach(function (e) {
    ...
    ((S.addons = {
                  ...
                  t
                    ? t.scrollHeight === t.offsetHeight
                      ...
                      : ((0 == t.scrollTop && 'down' == s.get()) ||
                          (t.scrollHeight == t.scrollTop + t.offsetHeight && 'up' == s.get())) &&
                        o(e)
                    : o(e);
                },
                {
              ...
              function () {
                if (!e.opts.offCanvas || e.vars.opened) {
                  ...
                  (e.node.menu.classList.add('mm-menu_autoheight-measuring'),
                    'auto' == t.height
                      ? ((s = _(e.node.pnls, '.mm-panel_opened')[0]) && (s = n(s)),
      ...
      dropdown: function () {
        ...
        if (this.opts.offCanvas) {
          ...
          if (t.drop) {
            ...
            (this.bind('initMenu:after', function () {
              if (
                (e.node.menu.classList.add('mm-menu_dropdown'), 'string' != typeof t.position.of)
              ) {
                var n = d(e.node.menu.id);
                ...
                if (n.matches('a'))
                  if (n.matches('.mm-iconbar__tab_selected')) e.stopImmediatePropagation();
                    ...
                    try {
                      ...
                      i &&
                        i.matches('.mm-panel') &&
                        (e.preventDefault(), e.stopImmediatePropagation(), t.openPanel(i, !1));
                    } catch (e) {}
              }));
            var r = function (t) {
                  ...
                  if (t.target.matches('a')) {
                    ...
                    ((i.scrollTop = 0),
                      g(i, '.mm-divider')
                        ...
                        .forEach(function (e) {
                          s < 0 &&
                            n == e.textContent.trim().slice(0, 1).toLowerCase() &&
                            (s = e.offsetTop);
                        }),
                      (i.scrollTop = s > -1 ? s : a));
                  }
      ...
      sidebar: function () {
        ...
        if (this.opts.offCanvas) {
          var t = (function (e) {
            return (
              ('string' == typeof e || ('boolean' == typeof e && e) || 'number' == typeof e) &&
                (e = {
                  expanded: e,
                }),
              'object' != typeof e && (e = {}),
      ...
      (S.wrappers = {
        ...
        bootstrap: function () {
                      ...
                      (function (e) {
                        ...
                        return (
                          g(e, '.nav-item').forEach(function (e) {
                            var n = b('li');
                            if (
                              (e.matches('.active') && n.classList.add('Selected'),
                              !e.matches('.nav-link'))
                            ) {
          ...
          function a(e) {
            for (
              var t = b(e.matches('a') ? 'a' : 'span'), n = ['href', 'title', 'target'], i = 0;
              i < n.length;
              i++
            )
