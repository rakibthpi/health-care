...
!(function (e, t) {
        ...
        if (!_e(e, 1)) {
          ...
          ((se.x = t),
            ...
            (i || Math.abs(se.startX - t) >= a || Math.abs(se.startY - r) >= a) &&
              (h && (re = !0), i || (se.isDragging = !0), df(n, o), i || (p && p(se))));
        }
      }
  ...
  function Ab(e, t) {
    if (ct(e)) {
      ...
      (~r && (e.indexOf('%') > r && (n *= t / 100), (e = e.substr(0, r - 1))),
        (e =
          n +
          (e in q ? q[e] * t : ~e.indexOf('%') ? (parseFloat(e) * t) / 100 : parseFloat(e) || 0)));
    }
    return e;
  }
    ...
    if ((p && ((s[p] = e || -0.001), e < 0 && (e = 0)), i)) {
      ...
      ((g = 'scroll' + n.d2),
        H(
          ...
          S,
          n,
          (k && 20 < S) || (!k && (u ? Math.max(We[g], Je[g]) : i.parentNode[g]) <= S + 1),
        ),
        u && ((l = _t(a)), u && (i.style[n.op.p] = l[n.op.p] - n.op.m - i._offset + xt)));
    }
    return (
      d &&
        v &&
  ...
  var Le,
    ...
    Q = function _updateAll(e) {
      if (!rt || 2 === e) {
        ...
        if (
          ((Mt = o < j ? -1 : 1),
          rt || (j = o),
          n && (st && !Ke && 200 < r - st && ((st = 0), V('scrollEnd')), (Ue = T), (T = r)),
          Mt < 0)
        ) {
    ...
    re =
        ...
        if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), lt)) {
          ...
          if (
            ...
            ue &&
              ...
              ze.forEach(function (e) {
                return (
                  Ra(e) && e.target === (me ? Xe.scrollingElement || Je : be) && (e.smooth = !1)
                );
              }),
              (p = Ra(ue.snapTo)
                ? ue.snapTo
            ...
            (i =
              (i =
                (ie = ke.trigger = J(ie || (!0 !== ae && ae))) && ie._gsap && ie._gsap.stRevert) &&
              i(ke)),
            (ae = !0 === ae ? ie : J(ae)),
            ct(T) &&
              (T = {
          ...
          if (
              ...
              if ((!je && ke.enabled) || t)
                if (ae && e && st) ub(ScrollTrigger, 'scrollEnd', Mb);
                  ...
                  var o,
                    ...
                    M = P;
                  for (
                    we && Ta(r) && ((h = Le.getProperty(q, he.p)), (v = Le.getProperty(H, he.p)));
                    M--;
                  )
                  ...
                  for (
                    ...
                    (u = (c = kt[M]).pin) &&
                      ...
                      !de &&
                      0 < c.end &&
                      ((o = c.end - (ke._startClamp ? Math.max(0, c.start) : c.start)),
                  ...
                  if (
                    ...
                    ke._endClamp &&
                      !rt &&
                      ((ke._endClamp = F || -0.001), (F = Math.min(F, Oa(be, he)))),
                    (N = F - D || ((D -= 0.01) && 0.001)),
                    ...
                    ((o = kb(ae)),
                      ...
                      !y &&
                        ...
                        me &&
                          'scroll' !== kb(We)['overflow' + he.a.toUpperCase()] &&
                    ...
                    for (i = ie.parentNode; i && i !== We; )
                      (i._pinOffset && ((D -= i._pinOffset), (F -= i._pinOffset)),
                        (i = i.parentNode));
                  (p &&
                    ...
                    (x || Oe !== ke.progress || de) &&
                      (O &&
                        !ve &&
                        O.totalProgress(
                          de && D < -0.001 && !Oe ? Le.utils.normalize(D, F, 0) : Oe,
                          !0,
                        ),
            ...
            (ke.labelToScroll = function (e) {
              return (
                (O && O.labels && (D || ke.refresh() || D) + (O.labels[e] / O.duration()) * N) || 0
              );
            }),
                    ...
                    a && !je
                      ? (ve &&
                        ...
                        pe &&
                          ...
                          (Ua(ke.callbackAnimation),
                          ee ? ee.progress(1) : Ua(O, 'reverse' === i ? 1 : !d, 1)))
                      : ve && k && !je && k(ke));
                }
                if (x) {
      ...
      (ScrollTrigger.register = function register(e) {
        return (
          s || ((Le = e || Ia()), Ha() && window.document && ScrollTrigger.enable(), (s = lt)),
          s
        );
      }),
  ...
  function yc(e) {
    ...
    var n,
      ...
      h = g && g.get(),
      v =
        R && ((e.content && J(e.content)) || (h && !1 !== e.content && !h.smooth() && h.content())),
      b = K(p, He),
      m = K(p, qe),
      y = 1,
      x =
    ...
    return (
      ...
      (e.onChange = function (e, t, r, n, o) {
        if (
          (Ct !== l && uq(), t && f && m(k(n[2] === t ? c + (e.startX - e.x) : m() + t - n[1])), r)
        ) {
          b.offset && vq();
          var i = o[2] === r,
