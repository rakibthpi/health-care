...
(!(function (t, e, n, o) {
      ...
      var i,
        ...
        u = function (t, o, i) {
          ((this.opts = n.extend(
            ...
            this.createGroup(t),
            this.group.length &&
              ((this.$lastFocus = n(e.activeElement).blur()), (this.slides = {}), this.init()));
        };
      (n.extend(u.prototype, {
            ...
            n.fancybox.getInstance() ||
              ...
              /iPad|iPhone|iPod/.test(navigator.userAgent) && !t.MSStream
                ...
                : !n.fancybox.isMobile &&
                  ...
                  (void 0 === h &&
                    ((o = n('<div style="width:50px;height:50px;overflow:scroll;" />').appendTo(
                      'body',
                    )),
                ...
                (r.match(
                  ...
                  : r.match(/\.(pdf)((\?|#).*)?$/i)
                    ...
                    : (a = r.match(/\.(mp4|mov|ogv)((\?|#).*)?$/i))
                      ? ((s = 'video'),
                        l.opts.videoFormat ||
                          (l.opts.videoFormat = 'video/' + ('ogv' === a[1] ? 'ogg' : a[1])))
                      : '#' === r.charAt(0) && (s = 'inline')),
          ...
          if (!(u.isDragging || u.isClosing || (u.isAnimating && u.firstRun))) {
            ...
            if (((i = u.firstRun = null === u.firstRun), !(f < 2 && !i && u.isDragging))) {
              if (
                ...
                (a.isMoved =
                  (0 !== l.left || 0 !== l.top) && !a.$slide.hasClass('fancybox-animated')),
              ...
              (n.each(u.slides, function (t, e) {
                      ...
                      n.fancybox.animate(
                        ...
                        function () {
                          (o.$slide
                            .removeAttr('style')
                            .removeClass('fancybox-slide--next fancybox-slide--previous'),
                            o.pos === u.currPos && ((a.isMoved = !1), u.complete()));
                        },
                      );
                    }))
                ...
                u.preload('image'),
                r.pos !== a.pos &&
                  ((h = 'fancybox-slide--' + (r.pos > a.pos ? 'next' : 'previous')),
                  r.$slide.removeClass(
        ...
        createSlide: function (t) {
          ...
          return (
            ...
            !this.slides[t] &&
              this.group[o] &&
              ((e = n('<div class="fancybox-slide"></div>').appendTo(this.$refs.stage)),
        ...
        scaleToActual: function (t, e, o) {
          ...
          'image' != h.type ||
            ...
            (s = 0.5 * u - 0.5 * p),
            (a = 0.5 * f - 0.5 * g),
            p > u && ((s = i.left * r - (t * r - t)) > 0 && (s = 0), s < u - p && (s = u - p)),
            g > f && ((a = i.top * c - (e * c - e)) > 0 && (a = 0), a < f - g && (a = f - g)),
            l.updateCursor(p, g),
            n.fancybox.animate(
              d,
              {
          ...
          if (e && !this.isClosing)
            return !!(
              ...
              ('zoom' === e.opts.clickContent ||
                (n.isFunction(e.opts.clickContent) && 'zoom' === e.opts.clickContent(e))) &&
        ...
        isScaledDown: function () {
          var t = this.current,
            ...
            o = !1;
          return (
            e && (o = (o = n.fancybox.getTranslate(e)).width < t.width || o.height < t.height),
            o
          );
        },
        canPan: function () {
          ...
          this.isClosing ||
            ...
            t.$slide.one('onReset', function () {
              (n(this).find('video,audio').trigger('pause'),
                t.$placeholder &&
                  (t.$placeholder.after(e.hide()).remove(), (t.$placeholder = null)),
        ...
        afterLoad: function (t) {
          this.isClosing ||
            ...
            t.opts.smallBtn &&
              !t.$smallBtn &&
              (t.$smallBtn = n(this.translate(t, t.opts.btnTpl.smallBtn)).appendTo(
        ...
        focus: function () {
          ...
          this.isClosing ||
            (e &&
              e.isComplete &&
              ((t = e.$slide.find('input[autofocus]:enabled:visible:first')).length ||
          ...
          return (
            ...
            !1 === u.trigger('beforeClose', t)
              ...
              : (u.removeEvents(),
                ...
                i &&
                  u.$refs.container.removeClass('fancybox-is-open').addClass('fancybox-is-closing'),
                u.hideLoading(f),
                u.hideControls(),
                u.updateCursor(),
                'zoom' !== o ||
                ...
                'zoom' === o
                  ? (n.fancybox.stop(s),
                    ...
                    'auto' == (a = f.opts.zoomOpacity) &&
                      (a = Math.abs(f.width / f.height - c.width / c.height) > 0.1),
                    a && (c.opacity = 0),
        ...
        (n.fancybox = {
          ...
          getTranslate: function (t) {
            ...
            if (
              ...
              e = (e = e.length > 10 ? [e[13], e[12], e[0], e[5]] : [e[5], e[4], e[0], e[3]]).map(
                parseFloat,
              );
            else {
              e = [0, 0, 1, 1];
  ...
  function f(t) {
    ...
    t.isDefaultPrevented() ||
      (t.preventDefault(),
      i
        ? (s = (a = (a = o.selector ? n(o.selector) : t.data ? t.data.items : []).length
    ...
    ((l.prototype.destroy = function () {
      ...
      (l.prototype.ontouchstart = function (o) {
        ...
        if (
          ...
          (!o.originalEvent || 2 != o.originalEvent.button) &&
            ...
            !r(i) &&
            !r(i.parent()) &&
            (i.is('img') || !(o.originalEvent.clientX > i[0].clientWidth + i.offset().left)))
        ) {
          ...
          ((this.realPoints = this.startPoints = s(o)),
            this.startPoints &&
              ...
              n(e)
                ...
                .on(u ? 'touchmove.fb.touch' : 'mousemove.fb.touch', n.proxy(this, 'ontouchmove')),
              n.fancybox.isMobile && e.addEventListener('scroll', this.onscroll, !0),
              (this.opts || l.canPan()) && (i.is(this.$stage) || this.$stage.find(i).length)
                ? ((n.fancybox.isMobile && (c(i) || c(i.parent()))) || o.preventDefault(),
                  ...
                  2 !== this.startPoints.length ||
                    ...
                    (this.centerPointStartX =
                      0.5 * (this.startPoints[0].x + this.startPoints[1].x) - n(t).scrollLeft()),
                    (this.centerPointStartY =
                      0.5 * (this.startPoints[0].y + this.startPoints[1].y) - n(t).scrollTop()),
          ...
          if (
            ...
            a.instance.group.length < 2 && a.opts.vertical
              ...
              : a.instance.isDragging ||
                ...
                ? (a.isSwiping = 'x')
                : ((s = Math.abs((180 * Math.atan2(a.distanceY, a.distanceX)) / Math.PI)),
            ...
            n.each(a.instance.slides, function (t, e) {
              (n.fancybox.stop(e.$slide),
                ...
                e.pos === a.instance.current.pos &&
                  (a.sliderStartPos.left = n.fancybox.getTranslate(e.$slide).left));
            }),
      ...
      (l.prototype.limitPosition = function (t, e, n, o) {
        var i = this.canvasWidth,
          s = this.canvasHeight;
        return (
          (t = n > i ? ((t = t > 0 ? 0 : t) < i - n ? i - n : t) : Math.max(0, i / 2 - n / 2)),
          {
            top: (e =
              o > s ? ((e = e > 0 ? 0 : e) < s - o ? s - o : e) : Math.max(0, s / 2 - o / 2)),
            left: t,
          }
        );
      }),
      ...
      (l.prototype.ontouchend = function (t) {
        ...
        ((this.speed = 366),
          ...
          (this.speedX = Math.max(
            0.5 * this.speed,
            Math.min(1.5 * this.speed, (1 / Math.abs(this.velocityX)) * this.speed),
          )),
        ...
        ((this.sliderLastPos = null),
          'y' == t && !e && Math.abs(this.distanceY) > 50
            ...
            : 'x' == t && this.distanceX > 50 && i > 1
              ...
              : 'x' == t && this.distanceX < -50 && i > 1 && (o = this.instance.next(this.speedX)),
          !1 !== o ||
            ('x' != t && 'y' != t) ||
            (e || i < 2
  ...
  (function (t, e) {
    ...
    (e.extend(n.prototype, {
      ...
      create: function () {
        ...
        ((this.$grid = e(
          '<div class="fancybox-thumbs fancybox-thumbs-' + this.opts.axis + '"></div>',
          ...
          this.$list
            ...
            .one('load', function () {
              ...
              ((t = this.naturalWidth || this.width),
                ...
                (o = t / a) >= 1 && i >= 1 && (o > i ? ((t /= i), (n = r)) : ((t = a), (n /= o))),
                e(this)
                  .css({
                    width: Math.floor(t),
                    height: Math.floor(n),
          ...
          'y' === this.opts.axis && (n.top < 0 || n.top > o.height() - e.outerHeight())
            ...
            : 'x' === this.opts.axis &&
              (n.left < o.parent().scrollLeft() ||
                n.left > o.parent().scrollLeft() + (o.parent().width() - e.outerWidth())) &&
      ...
      e(t).on('click', '[data-fancybox-share]', function () {
        ...
        s &&
          ...
          (n = s.current.opts.share.tpl
            .replace(
              /\{\{media\}\}/g,
              'image' === s.current.type ? encodeURIComponent(s.current.src) : '',
            )
  ...
  (function (t, e, n) {
    ...
    function r(t) {
      var e;
      '' !== t.gallery &&
        ((e = n("[data-fancybox='" + n.escapeSelector(t.gallery) + "']").eq(t.index - 1)).length ||
        ...
        (n(t).on({
          'onInit.fb': function (t, e) {
            ...
            !1 !== e.group[e.currIndex].opts.hash &&
              ((n = a()), (o = c(e)) && n.gallery && o == n.gallery && (e.currIndex = n.index - 1));
          },
          'beforeShow.fb': function (n, a, r) {
            ...
            r &&
              ...
              (l = c(a)) &&
              '' !== l &&
              (e.location.hash.indexOf(l) < 0 && (a.opts.origHash = e.location.hash),
